...
int main() {
    std::vector<dotOnSurface<double>> c = {dotOnSurface<double>(1, 2), dotOnSurface<double>(3, 4), dotOnSurface<double>(3, 6)};
    ...
    dotOnSurface<double> d = avgValue<dotOnSurface<double>>(c);
